...
hotels = pd.read_csv(r"C:\Users\anura\Desktop\Tourism-Website-qwerty-master\Tourism-Website-qwerty-master\Dataset\Hotels.csv")
...
class User(db.Model):
    ...
    def __init__(self,email,password,name):
        ...
        self.password = bcrypt_flask.generate_password_hash(password)
...
def recommend_places():
    ...
    data = pd.read_csv(r"C:\Users\anura\Desktop\Tourism-Website-qwerty-master\Tourism-Website-qwerty-master\Dataset\final_Types.csv", encoding='latin-1')   
...
def recommend_hotels():
    ...
    df = pd.read_csv(r"C:\Users\anura\Desktop\Tourism-Website-qwerty-master\Tourism-Website-qwerty-master\Dataset\Hotels.csv")
...
def recommend_restaurants():
    ...
    data_food = pd.read_csv(r"C:\Users\anura\Desktop\Tourism-Website-qwerty-master\Tourism-Website-qwerty-master\Dataset\zom_jaipur.csv", encoding='latin1')
